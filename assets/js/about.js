// About oldal specifikus JavaScript kód - teljes funkcionalitással a script.min.js-ből
    ...
    if (servicesSelectorBtn && servicesMenu && servicesSelector) {
        ...
        servicesSelectorBtn.addEventListener("click", function (e) {
            ...
            if (isHidden) {
                ...
                servicesSelectorBtn.setAttribute("aria-expanded", "true");
            } else {
                closeServicesMenu();
            }
        });
...
// About oldal specifikus inicializálás
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Inicializáljuk az összes szükséges funkciót
    initSmoothScrollbar();
    ...
    console.log('About oldal teljes funkcionalitással betöltve');
});
