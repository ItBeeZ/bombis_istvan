    ...
    if (servicesSelectorBtn && servicesMenu && servicesSelector) {
        ...
        servicesSelectorBtn.addEventListener('click', function(e) {
          ...
          if (isHidden) {
            ...
            let btnRect = servicesSelectorBtn.getBoundingClientRect();
            servicesMenu.style.position = 'fixed';
            servicesMenu.style.top = (btnRect.bottom + window.scrollY + 8) + 'px';
            servicesMenu.style.left = (btnRect.left + window.scrollX) + 'px';
            servicesMenu.style.minWidth = '288px';
            servicesMenu.style.padding = '8px 0';
            servicesMenu.style.zIndex = '9999';
            let w = servicesMenu.offsetWidth;
            if (!w || w === 0) {
              servicesMenu.style.width = '288px';
            }
            ...
            servicesMenu.style.left='';
            servicesMenu.style.minWidth='';
            servicesMenu.style.padding='';
